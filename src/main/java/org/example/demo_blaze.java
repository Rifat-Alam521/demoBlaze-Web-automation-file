...
public class demo_blaze {
    ...
    public static void main(String[]args) throws InterruptedException {
        String uname1 = "rifat" + getRandom(1000, 1000000);
        String pass1 = "18376391";
    ...
    public static void contact(ChromeDriver driver) throws InterruptedException {
        ...
        driver.findElement(By.id("recipient-email")).sendKeys("rifat6971@gmail.com");
        driver.findElement(By.id("recipient-name")).sendKeys("alam");
